...
func (c *SAPAPICaller) MaterialDistChannel(material, distributionChannel string) {
	data, err := c.callSalesPricingConditionSrvAPIRequirementMaterialDistChannel("A_SlsPrcgCndnRecdValidity", material, distributionChannel)
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) callToConditionRecord2(url string) (*sap_api_output_formatter.ToConditionRecord, error) {
	req, _ := http.NewRequest("GET", url, nil)
	c.setHeaderAPIKeyAccept(req)
...
func (c *SAPAPICaller) callToConditionRecord3(url string) (*sap_api_output_formatter.ToConditionRecord, error) {
	req, _ := http.NewRequest("GET", url, nil)
	c.setHeaderAPIKeyAccept(req)
...
func (c *SAPAPICaller) callToConditionRecord4(url string) (*sap_api_output_formatter.ToConditionRecord, error) {
	req, _ := http.NewRequest("GET", url, nil)
	c.setHeaderAPIKeyAccept(req)
